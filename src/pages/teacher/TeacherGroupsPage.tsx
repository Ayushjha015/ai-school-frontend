...
export function TeacherGroupsPage() {
  ...
  return (
    <SectionCard title="My classes" eyebrow="Groups assigned to you">
      {data.items.length === 0 ? (
        <EmptyState title="No groups assigned" description="Once groups are assigned to this teacher account, they will appear here." />
      ) : (
