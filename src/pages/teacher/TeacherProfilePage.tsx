    ...
    <div className="space-y-6">
      <SectionCard title="Teacher profile" eyebrow="Account overview">
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <StatCard label="Name" value={user?.name ?? 'Not available'} helper="Your display name for this workspace." accent="emerald" />
          <StatCard label="Role" value={formatRoleLabel(user?.role ?? 'teacher')} helper="Your current access level in the portal." accent="blue" />
