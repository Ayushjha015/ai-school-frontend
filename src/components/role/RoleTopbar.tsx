      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <h1 className="text-xl font-semibold leading-tight text-slate-950 sm:text-2xl">{portalName}</h1>
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">A focused overview of your workspace, updates, and performance today.</p>
          </div>
        </div>
        ...
        <div className="min-w-0 flex-1 text-right sm:flex-none">
          <p className="truncate text-sm font-semibold leading-5 text-slate-950">{user?.name ?? welcomeFallback}</p>
